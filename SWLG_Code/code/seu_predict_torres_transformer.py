...
def main():
    ...
    df = pd.read_csv("data/enviromental/ephin-soho/merged/merged_2001.csv")
    df["Timestamp"] = pd.to_datetime(df["Timestamp"])
    event = df[(df["Timestamp"]>="2001-09-24")&(df["Timestamp"]<="2001-09-26")]
    print("Sept 2001 max P_tot:", event["P_tot"].max())
